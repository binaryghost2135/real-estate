...
export default function HomePage() {
        ...
        if (typeof window !== 'undefined') {
            ...
            if (savedPropertiesString) {
                try {
                    ...
                    // Fallback to mockProperties is implicitly handled by initial state
                }
            }
            ...
            if (savedLikedIdsString) {
                try {
                    ...
                    setLikedPropertyIds(savedLikedIds);
                } catch (e) {
                    console.error("Failed to parse liked IDs from localStorage", e);
                    // Fallback to empty array is implicitly handled by initial state
                }
            }
        }
        setIsLoading(false);
    ...
    useEffect(() => {
        // Only save if not loading, to prevent overwriting initial load with mock data
